...
export class AppMenuService {
  ...
  updateChildInMenu(menuPath: string, childPath: string, updatedChild: Partial<MenuItem>): MenuItem | undefined {
    const menu = this.getMenuByPath(menuPath);
    const childIndex = menu?.children?.findIndex((child) => child.path === childPath);
